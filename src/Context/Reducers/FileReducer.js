...
export const fileReducer = (state,action) =>{
    switch(action.type){
        ...
        case ActionTypes.FILE_STATE_UPDATE_CURRENT_PAGE:
            return {...state, isLoading:false, errMess:null, files:state.files, currentPage:action.payload, lastEKMap:state.lastEKMap}
        case ActionTypes.FILE_STATE_ADD_LASTEK_MAP:
            return {...state, isLoading:false, errMess:null, files:state.files, currentPage:state.currentPage, lastEKMap:action.payload}
        case ActionTypes.FILE_STATE_UPDATE_LASTEK_MAP:
            ...
            return {...state, isLoading:false, errMess:null, files:state.files, currentPage:state.currentPage, lastEKMap:temp}
    }
}